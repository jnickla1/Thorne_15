...
def run_method(years, temperature, uncert, model_run, experiment_type):
    ...
    if (experiment_type=="historical" or exp_attr[2].lower()=="ssp245" or exp_attr[2].lower()=="rcp45" or exp_attr[0]=="histens"):
        ...
        comput_temps = comput_temps60 # doesnt really matter
    ...
    for i in range(avg_len_l+10, last_i):
        ...
        hindc_samps_mean = np.mean(comput_temps_align[i-avg_len_l-offset_yrs:i+avg_len_u-offset_yrs,:], axis = 0)
        hindc_samps = comput_temps_align[i-offset_yrs,:] #-10 because it starts in 1860 not 1850
