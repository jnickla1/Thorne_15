...
write.csv(fits_matrix, paste("output/gamAR1_fits_",args[1],".csv",sep=""), row.names=FALSE)
write.csv(se_matrix, paste("output/gamAR1_se_fits_",args[1],".csv",sep=""), row.names=FALSE)

write.csv(fits_matrix0, paste("output/gamAR0_fits_",args[1],".csv",sep=""), row.names=FALSE)
write.csv(se_matrix0, paste("output/gamAR0_se_fits_",args[1],".csv",sep=""), row.names=FALSE)
