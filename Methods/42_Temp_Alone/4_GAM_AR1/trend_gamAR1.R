...
setwd("~/Downloads/Thorne_figures/")
dat0=data.frame(read.table("/Users/JohnMatthew/Dropbox/KalmanFilterPython/toyKFmodelData8c.csv",header=FALSE,sep=","))
...
write.csv(fits_matrix, "gam_fits.csv", row.names=FALSE)

write.csv(se_matrix, "gam_se_fits.csv", row.names=FALSE)
