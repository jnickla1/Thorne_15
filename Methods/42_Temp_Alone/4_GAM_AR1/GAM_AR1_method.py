...
def run_method(years, temperature, uncert, model_run, experiment_type):
    ...
    comput_temps = pd.read_csv(cur_path+"/GAM_AR_Stephenson/gamAR1_fits_"+experiment_type+".csv", sep=',') #has header
    comput_uncert = pd.read_csv(cur_path+"/GAM_AR_Stephenson/gamAR1_se_fits_"+experiment_type+".csv", sep=',')
