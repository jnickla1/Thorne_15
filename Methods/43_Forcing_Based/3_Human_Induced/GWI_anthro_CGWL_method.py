...
def run_method(years, temperature, uncert, model_run, experiment_type):
    ...
    if experiment_type == 'historical':
        ...
        if (exp_attr[1]=='ESM1-2-LR'):
            ...
            biasdict = {"SSP126": -0.053106814-0.01538/2 , "SSP245": -0.050788712-0.02930/2,"SSP370": -0.05621548 -0.06436/2}
            ...
            biasdict = {"Volc": -0.203514147772356/2 -0.18392/2, "VolcConst": -0.245520955420054/2-0.23793/2}
