...
def run_method(years, temperature, uncert, model_run, experiment_type):
    ...
    if experiment_type == 'historical':
        ...
        curbias = -0.0340 #assuming this matches
        gwi_levels_curr0 = pd.read_csv(cur_path+"/heads_tails/individual_members/"+
                "GWI_results_AR6_HISTORICAL-ONLY_SCENARIO--observed_JK-2024-SSP245_ENSEMBLE-MEMBER--"+str(model_run)+
        ...
        if (exp_attr[1]=='ESM1-2-LR'):
            ...
            biasdict = {"SSP126": -0.059047725+0.02149/2 , "SSP245": -0.104804089-0.01479/2,"SSP370": -0.160773459-0.06804/2}
            ...
            biasdict = {"Volc": -0.316929745259552/2-0.303574/2, "VolcConst": -0.320460847270037/2-0.30533/2}
