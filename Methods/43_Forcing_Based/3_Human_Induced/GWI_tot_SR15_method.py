...
def run_method(years, temperature, uncert, model_run, experiment_type):
    ...
    if experiment_type == 'historical':
        ...
        curbias =  0.0289 #assuming this matches
        gwi_levels_curr0 = pd.read_csv(cur_path+"/heads_tails/individual_members/"+
                "GWI_results_SR15_HISTORICAL-ONLY_SCENARIO--observed_JK-2024-SSP245_ENSEMBLE-MEMBER--"+str(model_run)+
        ...
        if (exp_attr[1]=='ESM1-2-LR'):
            ...
            biasdict = {"SSP126": -0.016884271-0.01832/2, "SSP245": -0.025863309-0.03079/2,"SSP370": -0.045664823-0.054895/2}
            ...
            biasdict = {"Volc": -0.249811690999517/2-0.24181/2, "VolcConst": -0.254162516921968/2-0.24586/2}
