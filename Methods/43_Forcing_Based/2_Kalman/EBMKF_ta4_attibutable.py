...
erf_data_solar = pd.read_csv(os.path.expanduser(f"~/climate_data/SSP_inputdata/ERFs-Smith-ar6/ERF_ssp245_1750-2500.csv"))['solar'].to_numpy()[(1850-1750):]
...
aer_temps_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ts/aave_ts_Amon_MPI-ESM1-2-LR_hist-aer_r4i1p1f1_gn_185001-201412.nc", 'r').variables['ts']
...
aer_ohca_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ohca_aave/ohca_thetaot_Emon_MPI-ESM1-2-LR_hist-aer_r4i1p1f1_gn_185001-201412.nc", 'r').variables['__xarray_dataarray_variable__']
aer_ohca = average_every_n(aer_ohca_raw[:].__array__(), 12)
aer_ohca = aer_ohca - aer_ohca[0]
aer_toa_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/rt/combined_global_rt/hist-aer/global_rt_Amon_MPI-ESM1-2-LR_hist-aer_r4i1p1f1_gn_185001-186912.nc-201412.nc", 'r').variables['rt']
...
#recalculate CO2
forcingsdf = pd.read_csv(os.path.expanduser(f"~/climate_data/SSP_inputdata/ERFs-Smith-ar6/ERF_ssp245_1750-2500.csv"))
...
totalO3_temps_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ts/aave_ts_Amon_MPI-ESM1-2-LR_hist-totalO3_r4i1p1f1_gn_185001-201412.nc", 'r').variables['ts']
...
totalO3_ohca_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ohca_aave/ohca_thetaot_Emon_MPI-ESM1-2-LR_hist-totalO3_r4i1p1f1_gn_185001-201412.nc", 'r').variables['__xarray_dataarray_variable__']
totalO3_ohca = average_every_n(totalO3_ohca_raw[:].__array__(), 12)
totalO3_ohca = totalO3_ohca - totalO3_ohca[0]
totalO3_toa_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/rt/combined_global_rt/hist-totalO3/global_rt_Amon_MPI-ESM1-2-LR_hist-totalO3_r4i1p1f1_gn_185001-186912.nc-201412.nc", 'r').variables['rt']
...
GHG_temps_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ts/aave_ts_Amon_MPI-ESM1-2-LR_hist-GHG_r4i1p1f1_gn_185001-201412.nc", 'r').variables['ts']
...
GHG_ohca_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ohca_aave/ohca_thetaot_Emon_MPI-ESM1-2-LR_hist-GHG_r4i1p1f1_gn_185001-201412.nc", 'r').variables['__xarray_dataarray_variable__']
GHG_ohca = average_every_n(GHG_ohca_raw[:].__array__(), 12)
GHG_ohca = GHG_ohca - GHG_ohca[0]
GHG_toa_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/rt/combined_global_rt/hist-GHG/global_rt_Amon_MPI-ESM1-2-LR_hist-GHG_r4i1p1f1_gn_185001-186912.nc-201412.nc", 'r').variables['rt']
...
ekf.lCo2= np.full(ekf.n_iters,np.log10(ekf.data[0,2]))
#aer set to 0 - dont change
nat_temps_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ts/aave_ts_Amon_MPI-ESM1-2-LR_hist-nat_r4i1p1f1_gn_185001-201412.nc", 'r').variables['ts']
...
nat_ohca_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/ohca_aave/ohca_thetaot_Emon_MPI-ESM1-2-LR_hist-nat_r4i1p1f1_gn_185001-201412.nc", 'r').variables['__xarray_dataarray_variable__']
nat_ohca = average_every_n(nat_ohca_raw[:].__array__(), 12)
nat_ohca = nat_ohca - nat_ohca[0]
nat_toa_raw = Dataset(os.path.expanduser('~/')+"climate_data/attributable-warming_ESM1-2-LR/rt/combined_global_rt/hist-nat/global_rt_Amon_MPI-ESM1-2-LR_hist-nat_r4i1p1f1_gn_185001-186912.nc-201412.nc", 'r').variables['rt']
