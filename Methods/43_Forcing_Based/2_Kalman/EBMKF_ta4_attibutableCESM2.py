...
aer_temps_raw = Dataset(config.CLIMATE_DATA_PATH+"/attributable-warming_CESM2/ts/aave_ts_Amon_CESM2_hist-aer_r1i1p1f1_gn_185001-201412.nc", 'r').variables['tas']
...
aer_toa_raw = Dataset(config.CLIMATE_DATA_PATH+"/attributable-warming_CESM2/rt/aave_rtmt_Amon_CESM2_hist-aer_r1i1p1f1_gn_185001-201412.nc", 'r').variables['rtmt']
...
GHG_temps_raw = Dataset(config.CLIMATE_DATA_PATH+"/attributable-warming_CESM2/ts/aave_ts_Amon_CESM2_hist-GHG_r1i1p1f1_gn_185001-201412.nc", 'r').variables['tas']
GHG_temps = average_every_n(GHG_temps_raw[:].__array__(), 12)[:165]
...
GHG_toa_raw = Dataset(config.CLIMATE_DATA_PATH+"/attributable-warming_CESM2/rt/aave_rtmt_Amon_CESM2_hist-GHG_r1i1p1f1_gn_185001-201412.nc", 'r').variables['rtmt']
GHG_toa = average_every_n(GHG_toa_raw[:].__array__(), 12)[:165]
...
ekf.lCo2= np.full(ekf.n_iters,np.log10(ekf.data[0,2]))
#aer set to 0 - dont change
nat_temps_raw = Dataset(config.CLIMATE_DATA_PATH+"/attributable-warming_CESM2/ts/aave_ts_Amon_CESM2_hist-nat_r1i1p1f1_gn_185001-201412.nc", 'r').variables['tas']
...
nat_toa_raw = Dataset(config.CLIMATE_DATA_PATH+"/attributable-warming_CESM2/rt/aave_rtmt_Amon_CESM2_hist-nat_r1i1p1f1_gn_185001-201412.nc", 'r').variables['rtmt']
...
save_analytic_percentiles_from_mean_se("Nicklas_GMST_timeseriesCESM2.csv", years, data)
