...
annotate_fig=False
crossing_figs=False
sel_methods = ["CGWL10y_sfUKCP","GWI_tot_CGWL","FaIR_comb_unB","EBMKF_ta4"] #"FaIR_nonat""CGWL10y_for_halfU","CGWL10y_sfUKCP","FaIR_anthroA2","EBMKF_ta2","removeGreensfx" ]
...
def run_one_single_ens_member(plotting_figs, experiment_type, start_run, ax1, ax4, colorraw=None, elim_list = []):
    ...
    #To just read it back, don't compute anything new:
        ...
        #Line PLOT TO SHOW WHAT IT'S DOING
                    ...
                    if(labelcurr_or_retro=="c"):
                        if (method_name!="raw01y" and plotting_figs and method_name not in elim_list):
...
if __name__ == '__main__':
    ...
    if exp_attr[0]=="fut":
        ...
        nud = 0.5
        closest_years126, closest_yearsE126 = run_one_single_ens_member(plotting_figs, exp2, -min_run, ax1a, ax4a, colorcomb(colvolc,colnovolc),elim_list=e2list)
        closest_years370, closest_yearsE370 = run_one_single_ens_member(plotting_figs, exp2, -max_run, ax1b, ax4b, colvolc,elim_list=e2list)
